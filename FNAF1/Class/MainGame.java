...
public class MainGame {
    ...
    private void initSaveAndSounds() {
        SaveManager.load();
        SoundManager.loadAll("FNAF1/Sounds");
    }

    private static void initNightCommon() {
        running = true;
        can_play = true;
    ...
    public static void switchCamera(String cam_Id) {
        if (MainGame.getCurrentCamera().equals(cam_Id)) return;
    ...
    private static void installInputs(JFrame frame) {
        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_A -> toggleLeftDoor();
                    case KeyEvent.VK_D -> toggleRightDoor();

                    case KeyEvent.VK_Q -> toggleLeftLight();
                    case KeyEvent.VK_E -> toggleRightLight();

                    case KeyEvent.VK_SPACE -> toggleCamera();
                    case KeyEvent.VK_ESCAPE -> exitGame();
                }
            }
        });
    }
    private static void toggleLeftDoor() {
        left_door_close = !left_door_close;
        SoundManager.play("door_slamming_fnaf_1_sound_effects");
    }

    private static void toggleRightDoor() {
    ...
    private static void toggleLeftLight() {
        light_left = !light_left;
        SoundManager.play("fnaf-light-sound");
    }

    private static void toggleRightLight() {
